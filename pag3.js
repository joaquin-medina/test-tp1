const streetNews = axios.get('https://newsapi.org/v2/everything?domains=wsj.com&apiKey=affcf3bba7364c178fa3532776ac1119')
  .then((response) => {
...
const allNews = streetNews || []; //Guardo en la constante news la llamada a axios
